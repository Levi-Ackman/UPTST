...
class hand_foot(Dataset):
    def __init__(self, root_path='/home/Paradise/HFMD',data_type='train', size=None,split_ratio=[0.7,0.2,0.1],
                    data_path='cq_hfmd_2015_21.csv',tasks='MS_1',freq='d',timeenc=0,
                    scale=True):
    ...
    def __getitem__(self, index):
        ...
        return torch.tensor(seq_x, dtype=torch.float32),torch.tensor(seq_y, dtype=torch.float32),\
            torch.tensor(seq_x_mark, dtype=torch.float32), torch.tensor(seq_y_mark, dtype=torch.float32)
